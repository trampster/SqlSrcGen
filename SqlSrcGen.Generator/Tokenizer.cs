...
public class Tokenizer
{
    ...
    ReadOnlySpan<char> ReadToken(ReadOnlySpan<char> text, out Token read, ref int position, ref int lineIndex, ref int characterInLineIndex)
    {
        ...
        switch (text[0])
        {
            ...
            case ';':
                ...
                read = new Token()
                {
                    ...
                    Position = position,
                    Line = lineIndex,
                    CharacterInLine = characterInLineIndex,
            ...
            switch (text[index])
            {
                ...
                case '\'':
                    ...
                    read = new Token()
                    {
                        ...
                        Line = lineIndex,
                        CharacterInLine = characterInLineIndex,
                        TokenType = IsKeyword(tokenValue) ? TokenType.Keyword : TokenType.Other
                    };
                    position += index;
        ...
        read = new Token()
        {
            ...
            Line = lineIndex,
            CharacterInLine = characterInLineIndex,
            TokenType = IsKeyword(tokenValue1) ? TokenType.Keyword : TokenType.Other
        };
